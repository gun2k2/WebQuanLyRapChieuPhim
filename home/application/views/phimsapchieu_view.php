...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>css/phimsapchieu.css">
...
<body>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg_kem">
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
					    <a class="navbar-brand" href="<?php echo base_url(); ?>trang-chu">Brand</a>
	...
	<div style="margin-top: 81px; min-height: 420px;" class="main ">
					...
					<div class="col-3">
						<div class="card text-center bg-black mt-5">
							...
							<div class="card-body">
								...
								<a href="<?php echo base_url()."home_controller/phim/".$value['id']; ?>" class="btn btn-primary datve">Xem chi tiết</a> <?php echo $value['view'] ?> <i class="fa fa-eye" aria-hidden="true"></i>
							</div>
						</div>
					</div> <!-- end col-3 -->
					<?php endforeach; ?>
