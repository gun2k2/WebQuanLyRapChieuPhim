			...
			<form  class="form-inline" role="form" action="<?php echo base_url('admin/quanlyphim_controller/search'); ?>" method="post">
				...
				<tbody>
					...
					<tr class="text-center">
						...
						<td style="width: 20%;"><?php echo $value->tenphim; ?></td>
						<td style="width: 10%;"><?php echo $value->theloai; ?></td>
						<td style="width: 10%;"><?php echo $value->quocgia; ?></td>
						<td style="width: 10%;"><?php echo $value->thoiluong; ?></td>
						<td style="width: 20%;"><?php echo $value->p_id; ?></td>
						<td style="width: 20%;"><?php echo $value->giave; ?></td>
