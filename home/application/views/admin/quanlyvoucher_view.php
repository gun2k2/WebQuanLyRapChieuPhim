	...
	<div id="header">
		<nav class="navbar navbar-dark nav_turquoise">
			...
			<ul class="nav ">
				...
				<li class="nav-item">
					<a class="nav-link" href="<?php echo base_url(); ?>admin/quanlyvoucher_controller/logout"><i class="fas fa-sign-out-alt"></i>Đăng xuất</a>
				</li>
			</ul>
		</nav>
	</div> 
		...
		<div class="right clearfix">
			...
			<div class="top">
				<div class="row">
					...
					<div class="col-9">
						<ul>
							<li><a href="<?php base_url()?>quanlyvoucher_controller/add"><i class="fas fa-plus"></i>Thêm mới</a></li>
			...
			<div class="wrapper mt-5">
				...
				<table >
					<form  class="form-inline" role="form" action="<?php echo base_url('admin/quanlyvoucher_controller/search'); ?>" method="post">
					  <div class="form-group">
					    <div class="row justify-content-center">
					      	<div class="col-4">
					      		<label>Mã voucher:</label>
					      		<input style="width: 200px; height: 40px;" type="text"  name="ma_voucher"	 placeholder="Nhập mã...">
					      	</div>
					      	<div class="col-4">
				...
				<thead >
					<tr class="text-center">
						...
						<td style="width: 20%;">Mã</td>
						<td style="width: 20%;">Giảm(%)</td>
				...
				<tbody>
					...
					<tr class="text-center">
						...
						<td style="width: 20%;"><?= $value['ma_voucher'] ?></td>
						<td style="width: 20%;"><?= $value['percent'] ?></td>
						
						<td style="width: 10%;">
							<a href="quanlyvoucher_controller/editData/<?= $value['id'] ?>"><i class="fas fa-wrench fix"></i></a>
							<a id="<?php echo $value['id'] ?>" href="quanlyvoucher_controller/deleteData/<?= $value['id'] ?>"><i class="fas fa-user-times remove"></i></a>
						</td>
					</tr>
					<!-- end table row -->
					<?php endforeach ?>
				...
				<tfoot class="text-center">
					<tr >
						...
						<td >
						<a href="<?php base_url()?>quanlyvoucher_controller/sapxep" class="btn btn_red btn-sm"><i class="fas fa-arrows-alt-v"></i></a>
						</td>
		...
		$(document).ready(function() {
			$('.remove').click(function(event) {
				...
				if(confirm("Bạn có muốn xóa mục này ?")){
					window.location = "quanlyvoucher_controller/deleteData/<?= $value['id'] ?>";
				}else{
						return false;
				}
			});
