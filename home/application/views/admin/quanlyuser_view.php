		...
		<div class="left">
			...
			<div class="menu">
				<ul>
					...
					<li>
					<a class="selected" href="<?php echo base_url(); ?>admin/home_controller"><i class="fas fa-male"></i>Quản lý admin</a>
					</li>
					<li>
					<a class="selected" href="<?php echo base_url(); ?>admin/quanlyuser_controller"><i class="fas fa-male"></i>Quản lý Member</a>
					</li>
		 			...
		 			<tbody>
						...
						<tr class="text-center">
							...
							<td class="option">
								...
								<a href="home_controller/editData/<?= $value['id'] ?>" class="fas fa-wrench fix"></a>

								<a id="<?php echo $value['id'] ?>" href="home_controller/deleteData/<?= $value['id'] ?>" class="fas fa-user-times remove verify_action">
