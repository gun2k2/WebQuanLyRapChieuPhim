		...
		<nav class="navbar navbar-dark nav_turquoise">
			...
			<ul class="nav ">
				<li class="nav-item active">
					<a class="nav-link" href="<?php echo base_url(); ?>home_controller"><i class="fas fa-home"> Trang chủ </i> <span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item">
			...
			<div class="wrapper mt-5">
					...
					<form  class="form-inline" role="form" action="<?php echo base_url('admin/quanlyvoucher_controller/search'); ?>" method="post">
					    ...
					    <div class="row justify-content-center">
					      	<div class="col-4">
					      		...
					      		<input style="width: 200px; height: 40px;" type="text"  name="ma_voucher"	 placeholder="Nhập tên cần tìm...">
					      	</div>
					      	<div class="col-4">
				...
				<tbody>
					...
					<tr class="text-center">
						...
						<td style="width: 20%;"><?php echo $value->ma_voucher; ?></td>
						<!-- <td style="width: 10%;">
							<a href="quanlyvoucher_controller/editData/<?= $value['id'] ?>"><i class="fas fa-wrench fix"></i></a>
							<a id="<?php echo $value['id'] ?>" href="quanlycoucher_controller/deleteData/<?= $value['id'] ?>"><i class="fas fa-user-times remove"></i></a>
						</td> -->
					</tr>
					<!-- end table row -->
					<?php endforeach ?>
