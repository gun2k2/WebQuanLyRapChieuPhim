...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>css1/qllichchieu.css">
		...
		<div class="right clearfix">
			...
			<div class="top">
				<div class="row">
					...
					<div class="col-9">
						<ul>
							<li><a href="http://localhost/home/admin/quanlylichchieu_controller/add"><i class="fas fa-plus"></i>Thêm mới</a></li>
			...
			<div class="wrapper mt-5">
				...
				<!-- table -->
				<table >
					<form  class="form-inline" role="form" action="<?php echo base_url('admin/quanlylichchieu_controller/search'); ?>" method="post">
				...
				<thead >
					<tr class="text-center">
						...
						<td style="width: 10%;">Ngày chiếu</td>
...
<!--END Dòng cần thiết để chuyển số thành chữ -->
					...
					<!-- table row -->
						<tr class="text-center">
							...
							<td style="width: 10%;"><?= $value['ngaychieu'] ?></td>
							
							<td style="width: 10%;"><?= $value['thoigian'] ?></td>
						<td style="width: 10%;">
						<a href="quanlylichchieu_controller/editData/<?= $value['id'] ?>"><i class="fas fa-wrench fix"></i></a>

						<a id="<?php echo $value['id'] ?>" href="quanlylichchieu_controller/deleteData/<?= $value['id'] ?>"><i class="fas fa-user-times remove"></i></a></td>
						</tr>
					<!-- end table row -->
					<?php endforeach ?>
				...
				<tfoot class="text-center">
						...
						<td >
						<a href="<?php base_url()?>quanlylichchieu_controller/sapxep" class="btn btn_red btn-sm"><i class="fas fa-arrows-alt-v"></i></a>
						</td>
		...
		$(document).ready(function() {
			$('.remove').click(function(event) {
				...
				if(confirm("Bạn có muốn xóa mục này ?")){
					window.location = "quanlylichchieu_controller/deleteData/<?= $value['id'] ?>";
				}else{
						return false;
				}
			});
