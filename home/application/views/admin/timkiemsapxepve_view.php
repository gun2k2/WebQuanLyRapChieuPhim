...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>css1/timkiem.css">
			...
			<div class="wrapper mt-5">
				...
				<tbody>
					...
					<tr class="text-center">
						...
						<td style="width: 10%;"><?php echo $value->ma_ve ?></td>
										
										
										
					<?php $manglichchieu= $CI->showlichchieu_model->ktdanhmuc($value->lichchieu)  ?>
										<?php foreach ($manglichchieu as $key): ?>
					<td style="width: 20%;"> <?= $CI->showphim_model->ktdanhmuc($key['tenphim'])  ?></td>
											<td style="width: 10%;"><?=$CI->showphong_model->ktdanhmuc($key['phong']) ?></td>
											<td style="width: 10%;"><?=$key['thoigian'] ?></td>
										<?php endforeach ?>
										
										<td style="width: 10%;"><?php echo $value->ngaymua ?></td>
										<td style="width: 10%;"><?php echo $value->maghe ?></td>
										<td style="width: 10%;"><?php echo $value->giave ?></td>
