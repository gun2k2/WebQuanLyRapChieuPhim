...
<head>
	...
	<title>Tìm kiếm lịch chiếu</title>
		...
		<div class="right clearfix">
			...
			<div class="top">
				<div class="row">
					...
					<div class="col-9">
						<ul>
							<li><a href="<?php base_url()?>quanlylichchieu_controller/add"><i class="fas fa-plus"></i>Thêm mới</a></li>
...
<!--END Dòng cần thiết để chuyển số thành chữ -->
					...
					<tr class="text-center">
						...
						<td style="width: 10%;"><?= $CI->showphim_model->ktdanhmuc($value['tenphim']) ?></td>
						<td style="width: 10%;"><?= $CI->showphong_model->ktdanhmuc($value['phong']) ?></td>
						<td style="width: 10%;"><?php echo $value['ngaychieu']; ?></td>
						<td style="width: 10%;"><?php echo $value['thoigian']; ?></td>
