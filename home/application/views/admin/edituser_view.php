	...
	<div id="main">
		...
		<div class="right clearfix">
			...
			<div class="wrapper mt-5">
				...
				<form action="http://localhost/home/admin/quanlyuser_controller/updateDulieu" id="form"  class="form" action="" method="post"  enctype="multidata/form-data">

					<div class="form-group row">
						
						 	<label for="param_username"  class="col-sm-2 col-form-label">ID</label>
							<div class="col-sm-5">
							<input name="id"  type="button"  class="form-control" value="<?= $value['id'] ?>">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-5">
				      <input type="text" autocheck="true" name="name" value="<?= $value['name']?>" class="form-control" id="tenNhanVien"  placeholder="Tên nhân viên" required="">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-5">
				      <input type="button" autocheck="true" name="email" value="<?= $value['email']?>" class="form-control" id="userName"   placeholder="email...">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-5">
				      <input type="password" autocheck="true" value="<?= $value['password']?>" name="password" class="form-control" id="PassWord" placeholder="Password">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-5">
				      <input type="password" value="<?= $value['password']?>" autocheck="true" name="re_password" class="form-control" id="rePassWord" placeholder="rePassword">
				   ...
				   <div class="form-group row">
				    ...
				    <div class="col-sm-5">
				      <input type="date" autocheck="true" name="ngaysinh" value="<?= $value['ngaysinh']?>" class="form-control" id="param_ngaysinh"  placeholder="ngaysinh..." required="">
				  ...
				  <div class="form-group row">
				    <label for="param_sdt" class="col-sm-2 col-form-label">sdt</label>
				    <div class="col-sm-5">
				      <input type="tell" autocheck="true" name="sdt" value="<?= $value['sdt']?>" class="form-control" id="param_sdt"  placeholder="sdt..." required="">
				     
				    </div>
				  </div>

				  	 <div class="form-group row">
				    <label for="param_diachi" class="col-sm-2 col-form-label">dia chi</label>
				    <div class="col-sm-5">
				      <input type="text" autocheck="true" name="diachi" value="<?= $value['diachi']?>" class="form-control" id="param_diachi"  placeholder="diachi..." required="">
